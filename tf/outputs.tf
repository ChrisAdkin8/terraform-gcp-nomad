output "cluster_summary" {
  value = join("\n", [
    ...
    "Grafana Management Console : http://grafana.traefik-dc1.${var.dns_zone}:8080",
    "Alloy Gateway API Endpoint : http://gateway.traefik-dc1.${var.dns_zone}:8080",
    "Loki Endpoint              : http://loki.traefik-dc1.${var.dns_zone}:8080",
    "",
