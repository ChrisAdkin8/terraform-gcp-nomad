output "cluster_summary" {
  value = join("\n", [
    ...
    "Alloy Collector UI Endpoint : http://collector.traefik-dc1.${local.project_id}.${local.base_domain}:8080",
    "Alloy Gateway Loki Endpoint : http://gateway-api.traefik-dc1.${local.project_id}.${local.base_domain}:8080/loki/api/v1/push",
