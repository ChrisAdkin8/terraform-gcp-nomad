...
EOF
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.loki.rule=Host(`loki.${host_url_suffix}`) && (PathPrefix(`/loki/api/v1/push`) || PathPrefix(`/loki/api/v1/query`) || PathPrefix(`/loki/api/v1/metrics`) || PathPrefix(`/loki/api/v1/flush`))",
